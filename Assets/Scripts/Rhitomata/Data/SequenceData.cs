...
namespace Rhitomata.Data {
    public class SequenceData {
        ...
        public List<BPMInfo> bpms { get; set; } = new() { new BPMInfo() };
        public List<SpeedInfo> speeds { get; set; } = new() { new SpeedInfo() };
        public List<DirectionInfo> directions { get; set; } = new() { new DirectionInfo() };

        /// <summary>
        /// The relative path of the sequence based on the project's directory
        /// </summary>
